        ...
        <nav className="">
          <a className="logo" href="/">
            <img
              ...
              alt="logo webAI"
              className="h-[50px] w-[250px] -ml-10"
            />
          </a>
          ...
          <div
            id="mobileMenu"
            className="hs-colllapse transition-all duration-300 lg:basis-auto basis-full grow hiiden lg:flex items-center justify-center mx-auto mt-2 lg:mt-0"
          >
            ...
            <div className="lg:hidden flex items-center pt-4 mt-4 lg:pt-0 lg:mt-0 border-t border-white/10 lg:border-none">
              <a
                href="#"
                className="inline-flex items-center justify-center gap-2 bg-primary text-white py-2 px-6 rounded-full hover:bg-primary-hover transition-all duration-200"
              >
                <SiBlockchaindotcom />
